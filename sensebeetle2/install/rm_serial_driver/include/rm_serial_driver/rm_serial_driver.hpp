...
private:
  ...
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr keyboard_teleop_sub_;  // 键盘遥控订阅者
  ...
  // callback functions
  void keyboardTeleopCallback(const std_msgs::msg::String::SharedPtr key_msg);  // 键盘遥控回调函数
};
}  // namespace rm_serial_driver
